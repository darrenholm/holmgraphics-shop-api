...
async function missingDocuments() {
  return query(
    `SELECT v.unit_number, v.license_plate, v.inspection_required, t.doc_type
      ...
      -- Equipment holds no annual-PMVI sticker and no plate insurance card,
      -- so nagging about either every Monday would be noise that trains
      -- people to skim the digest.
