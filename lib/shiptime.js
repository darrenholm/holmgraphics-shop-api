...
async function fetchOauthToken() {
  ...
  const _basic   = basicHeader();
  console.log('[shiptime DEBUG] basicHdr   ', _basic.slice(0, 12) + '…' + _basic.slice(-6), 'len=' + _basic.length);
  ...
  console.log('[shiptime DEBUG] respBody   ', JSON.stringify(text));
  let parsed;
