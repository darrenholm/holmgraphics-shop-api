...
async function fetchOauthToken() {
  ...
  // OAuth2 client_credentials grant. ShipTime's OAuth gateway rejects
  // requests that include an `Authorization: Basic` header alongside
  // body credentials — returns 401 with empty body (nginx-level reject)
  // even though the same pair works via curl. Send credentials in the
  // body only.
