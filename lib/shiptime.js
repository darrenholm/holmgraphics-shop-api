...
//
// Auth: the spec doesn't carry a securityDefinitions block but every error
// path mentions "Invalid username/password" — we send HTTP Basic with
// `SHIPTIME_CLIENT_ID:SHIPTIME_API_SECRET` from env vars. Set
// SHIPTIME_BASE_URL=https://restapi.shiptime.com/rest for production or
// https://sandboxapi.shiptime.com/rest for sandbox.
//
